...
import FirstTimersManagement from "./pages/admin/FirstTimersManagement";
        ...
        >
          <Routes>
            ...
            >
              ...
              {/* 
                  Note: create/edit are handled via modal in AttendanceManagement.
                  Accessing sub-routes directly will just show the main page 
                  (or 404 if we don't handle it, but for now we just keep the main route).
                */}
              ...
              <Route
                path="first-timers"
                element={
                  <ProtectedRoute requiredPermission="first_timers">
              ...
              {/* Admin Management - SUPER_ADMIN and ADMIN only */}
              <Route
